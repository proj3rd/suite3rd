...
function canMerge(parent, child) {
    ...
    if (parent.presence !== "" &&
        parent.presence !== "M" &&
        parent.presence !== "O" &&
        (firstElement === null || firstElement === void 0 ? void 0 : firstElement.presence) !== "" &&
        (firstElement === null || firstElement === void 0 ? void 0 : firstElement.presence) !== "M" &&
        (firstElement === null || firstElement === void 0 ? void 0 : firstElement.presence) !== "O" &&
        parent.presence !== (firstElement === null || firstElement === void 0 ? void 0 : firstElement.presence)) {
        return false;
    }
    if (parent.range !== "" || (firstElement === null || firstElement === void 0 ? void 0 : firstElement.range) !== "") {
        return false;
    }
    if (parent.criticality !== "" &&
        (firstElement === null || firstElement === void 0 ? void 0 : firstElement.criticality) !== "" &&
        parent.criticality !== (firstElement === null || firstElement === void 0 ? void 0 : firstElement.criticality)) {
        return false;
    }
    if (parent.assignedCriticality !== "" &&
        (firstElement === null || firstElement === void 0 ? void 0 : firstElement.assignedCriticality) !== "" &&
        parent.assignedCriticality !== (firstElement === null || firstElement === void 0 ? void 0 : firstElement.assignedCriticality)) {
        return false;
    }
    return true;
}
        ...
        for (let i = elementListExpanded.length - 1; i >= 0; i -= 1) {
            ...
            if (matchResult) {
                ...
                if (definitionReferenced) {
                    const definitionExpanded = cloneDeep(definitionReferenced).expand(definitions);
